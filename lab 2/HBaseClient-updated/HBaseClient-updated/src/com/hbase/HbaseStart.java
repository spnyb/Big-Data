...
public class HbaseStart
{
	...
	public static void createTable() throws IOException
	{
		...
		try {
			// HBaseConfiguration hc = new HBaseConfiguration(new Configuration());
			  ...
			  HTableDescriptor ht = new HTableDescriptor("savya"); 
	...
	public static void insertTable() throws IOException{
		...
		config.clear();
         ...
         String latitude="",longitude="",Date="",x="",y="",z="",x1="",y1="",z1="";
		  ...
		  HTable table = new HTable(config, "savya");
        ...
        BufferedReader br = null;
 		...
 		try {
 			...
 			br = new BufferedReader(new FileReader("C://sensorj3.txt"));
 ...
 byte [] value6 = r.getValue(Bytes.toBytes("x1"),Bytes.toBytes("col7"));
		  
		  byte [] value7 = r.getValue(Bytes.toBytes("y1"),Bytes.toBytes("col8"));
		  
		  byte [] value8 = r.getValue(Bytes.toBytes("z1"),Bytes.toBytes("col9"));
		  byte[] value9=r.getValue(Bytes.toBytes("gyroscope"),Bytes.toBytes("col10"));
 ...
 String valueStr7 = Bytes.toString(value7);
		  ...
		  String valueStr9 = Bytes.toString(value9);
		  ...
		  System.out.println("GET: " +"z: "+ valueStr9);
		  ...
		  s.addColumn(Bytes.toBytes("gyroscope"), Bytes.toBytes("col3"));
	...
	public static void deleteTable() throws IOException{
		...
		config.clear();
         ...
         HBaseAdmin admin = new HBaseAdmin(config);
         admin.disableTable("savya");
         admin.deleteTable("savya");
